...
/*	mdelay(30);*/
	...
	core = hdmi_read_reg(HDMI_CORE_SYS, HDMI_CORE_SYS__INTR_STATE);
	if ((val & HDMI_WP_IRQSTATUS_CORE) && (core & 0x1)) {
		i1 = hdmi_read_reg(HDMI_CORE_SYS, HDMI_CORE_SYS__INTR1);
		i2 = hdmi_read_reg(HDMI_CORE_SYS, HDMI_CORE_SYS__INTR2);
		i3 = hdmi_read_reg(HDMI_CORE_SYS, HDMI_CORE_SYS__INTR3);

		hdmi_write_reg(HDMI_CORE_SYS, HDMI_CORE_SYS__INTR1, i1);
		hdmi_write_reg(HDMI_CORE_SYS, HDMI_CORE_SYS__INTR2, i2);
		hdmi_write_reg(HDMI_CORE_SYS, HDMI_CORE_SYS__INTR3, i3);
	...
	if (i2 & HDMI_IP_CORE_SYSTEM__INTR2__BCAP)
		*r |= HDMI_BCAP;

	if (i3 & HDMI_IP_CORE_SYSTEM__INTR3__RI_ERR)
		*r |= HDMI_RI_ERR;
