...
static int cdrom_allow_eject = 1;
module_param_named(allow_eject, cdrom_allow_eject, bool, S_IRUGO | S_IWUSR);
MODULE_PARM_DESC(allow_eject, "true to allow ejection of the cdrom devioe");
#endif
